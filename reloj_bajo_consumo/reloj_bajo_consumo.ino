/*
   ...
   Nombre :
            Farinago Luis
   Realizar un  programa de un programa de reloj con un bajo consumo de energia 
*/
...
int volatile contseg = 0 ;//variabla para guardar los datos de segundos ,se inicializa en cero
int volatile contmin = 0 ;//variabla para guardar los datos de minutos,se inicializa en cero
int volatile conthor = 0 ;//variabla para guardar los datos de horas ,se inicializa en cero
void setup() {//**********************************************************************************************************
